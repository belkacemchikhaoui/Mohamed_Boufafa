...
nb4['cells'][0]['source'] = ["# Phase M5 — Video B v4: ET/TC Push (ET×10 focal + containment + oversample)\n**Target:** TC≥0.80, ET≥0.80\n---"]
...
# ── Cell 6: Loss with Phase 1 (ET×10 focal + TC focal) ───────────────
nb4['cells'][6]['source'] = ["""# Phase 1: Hybrid Loss — ET×10 focal + TC focal + wMSE + Dice
...
print('Loss: wMSE + Dice + CE(ET×10) + focal_ET(γ=3) + focal_TC(γ=2)')"""]
