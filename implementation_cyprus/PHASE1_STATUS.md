...
| Task | Status | Notes |
| ---- | ------ | ----- |
| Intra-visit alignment | DONE | 176/176 (100%) modality pairs match |
| Inter-visit alignment | DONE | 552/552 (100%) cross-visit pairs match |
| CoM shift analysis | DONE | Mean ~2 mm, max ~6 mm (within tolerance) |
| Total checks | DONE | 728 affine checks across all patients, modalities, visits |
...
| Missing masks documented | DONE | 15/186 visits without masks (likely resolved tumors) |
