...
EXPERIMENTS = {
    "swinunetr": {
        "slug": "boufafamoamed/swinunetr-fold-outputs",
        "title": "Swin UNETR Fold Outputs (Phase 3)",
        "prefix": "swinunetr",
    },
    "bsf": {
        "slug": "boufafamoamed/brainsegfounder-fold-outputs",
...
for search_dir in search_dirs:
    ...
    for pat in [f"**/{FILE_PREFIX}_fold*_best.pth", f"**/{FILE_PREFIX}_fold*_latest.pth",
                f"**/{FILE_PREFIX}_embeddings_fold*.npz", f"**/{FILE_PREFIX}_embeddings_fold*_meta.json",
                f"**/{FILE_PREFIX}_fold*_training_curves.png", f"**/{FILE_PREFIX}_fold*_metrics.json"]:
