...
| Total visit dates         | 236 (from DICOM dates)                                    |
| MRI visits (BraTS/)       | 187 (171 with masks + 16 without)                         |
| Expert segmentation masks | 171 (16 visits without masks)                             |
| CT scans                  | 45/45 (100%)                                              |
| RT dose plans             | 45/45 (100%)                                              |
| Resolution                | 1x1x1 mm isotropic, 240x240x155                           |
| Alignment                 | 744/744 affine checks passed (180 intra + 564 inter)      |
...
- **NSCLC** (Non-Small Cell Lung Cancer): Most common lung cancer (~85% of all lung cancers). The dominant primary in this cohort (62%), consistent with NSCLC being the leading cause of brain metastases worldwide.
- **SCLC** (Small Cell Lung Cancer): Aggressive, high rate of brain metastasis. Only 2% of this cohort (1 patient).
- **Breast**: Second most common source of brain mets. 36% of cohort (17 patients).
...
| **FSRT (Fractionated SRT)** | 11 | 23.4% | Multiple fractions (3×11.7 Gy = 35 Gy total) |
...
> Note: 236 total visit dates exist in DICOM data; 187 have BraTS MRI data. Above counts come from clinical metadata (47 patient entries, each tracked over time).
...
16 visits across 8 patients have no mask at all -- likely complete tumor response after treatment.
...
| # | Reference | Relevance |
|---|---|---|
| [D1] | Flouri, D., Pattichis, C., et al. (2025). *Cyprus PROTEAS: A Longitudinal Brain Metastasis Dataset with Multi-class Segmentation, CT, and Radiation Therapy Planning Data.* Zenodo. DOI: [10.5281/zenodo.17253793](https://doi.org/10.5281/zenodo.17253793) | Primary dataset |
| [D2] | Moawad, A.W., et al. (2023). *Brain Tumor Segmentation (BraTS) Challenge 2023.* arXiv:2305.19369 | BraTS label convention we follow (NCR=1, ET=2, ED=3) |

### Clinical Guidelines

| # | Reference | How It Informed Our Analysis |
|---|---|---|
| [C1] | Lin, N.U., et al. (2015). *Response Assessment in Neuro-Oncology (RANO) criteria for brain metastases.* Lancet Oncology, 16(6), e270-e278 | Response classification thresholds (>25% change) |
| [C2] | Vogelbaum, M.A., et al. (2022). *Treatment for Brain Metastases: ASCO-SNO-ASTRO Guideline.* JCO, 40(5), 492-516 | KPS ≥70 SRS eligibility; RS vs FSRT selection |
| [C3] | Yamamoto, M., et al. (2014). *SRS for patients with multiple brain metastases (JLGK0901).* Lancet Oncology, 15(4), 387-395 | SRS dosimetry standards (hotspot 120-130% of marginal) |
| [C4] | Soffietti, R., et al. (2017). *Diagnosis and treatment of brain metastases from solid tumors: guidelines from EANO.* Neuro-Oncology, 19(2), 162-174 | Treatment selection for brain mets, performance status criteria |
| [C5] | Nayak, L., et al. (2012). *Epidemiology of brain metastases.* Current Oncology Reports, 14(1), 48-54 | Epidemiological context: NSCLC as leading primary, cerebellum as common location |

### Radiomics

| # | Reference | Relevance |
|---|---|---|
| [R1] | van Griethuysen, J.J.M., et al. (2017). *Computational Radiomics System to Decode the Radiographic Phenotype.* Cancer Research, 77(21), e104-e107 | PyRadiomics feature definitions (7 categories, 105 features) |
| [R2] | Lambin, P., et al. (2017). *Radiomics: the bridge between medical imaging and personalized medicine.* Nature Reviews Clinical Oncology, 14(12), 749-762 | Theoretical framework for radiomic biomarkers |
| [R3] | Aerts, H.J.W.L., et al. (2014). *Decoding tumour phenotype by noninvasive imaging.* Nature Communications, 5, 4006 | Prognostic value of radiomic features |
| [R4] | Peng, L., et al. (2021). *Distinguishing true progression from radionecrosis after stereotactic radiation therapy for brain metastases with machine learning and radiomics.* Int. J. Radiation Oncology, 106(5), 960-969 | Radiomics for necrosis vs recurrence distinction |

### Preprocessing

| # | Reference | Relevance |
|---|---|---|
| [P1] | Bakas, S., et al. (2017). *Advancing The Cancer Genome Atlas glioma MRI collections with expert segmentation labels and radiomic features.* Scientific Data, 4, 170117 | BraTS preprocessing protocol (Z-score, co-registration, 1mm isotropic) |
| [P2] | Isensee, F., et al. (2021). *nnU-Net: a self-configuring method for deep learning-based biomedical image segmentation.* Nature Methods, 18, 203-211 | Preprocessing best practices for 3D medical images |
