...
- Intra-visit (modalities within same session): 180/180 match
- Inter-visit (follow-ups vs baseline): 564/564 match
- CoM shift: ~2 mm average (within clinical tolerance)
- Total: 744 checks. No additional registration needed.
...
**Missing masks:** 16/187 visits (8 patients) lack masks. Likely: complete tumor response, lesion too small, or scan not annotated. All visits shown in visualizations (with/without mask).
